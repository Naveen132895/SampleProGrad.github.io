...
jasmineRequire.HtmlReporter = function(j$) {
  ...
  function HtmlReporter(options) {
    ...
    this.initialize = function() {
      ...
      htmlReporterMain = createDom('div', {className: 'jasmine_html-reporter'},
        createDom('div', {className: 'jasmine-banner'},
          createDom('a', {className: 'jasmine-title', href: 'https://www.focusacademy.in/', target: '_blank'}),
    ...
    this.jasmineDone = function(doneResult) {
      ...
      labName.appendChild(createDom('img', {src: 'jasmine/jasmine-2.8.0/face4d.png'}, ''));
      labName.appendChild(createDom('span', {}, 'DAY 2 | Lab - 2 | Functions & Arrays'));
      ...
      if (totalSpecsDefined > 0) {
        ...
        statusBarMessage += pluralize('spec', specsExecuted) + ', ' + pluralize('failure', failureCount)+ ', ' + pluralize('Percentage', percent);
